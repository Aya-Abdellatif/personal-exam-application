...
class ExamMaker:
    """
    A static class representing an exam maker that has all the methods
    needed to create an exam or multiple exams.
    """
    ...
    def make_random_exam() -> list[Question]:
        """
        :return: returns a list of 20 Question objects (5 questions for each topic)
        """
    ...
    def get_exams(
        ...
        """
        detect the best exam combinations and then returns multiple exams given the exam count needed
        :param exam_count: the number of exams to generate
        :param filtered_frequent_itemsets: the frequent itemsets generated by FP-tree algorithm with no duplicate
        values.
        :return: a list of `exam_count` lists (exams) each containing 20 questions.
        """
    ...
    def _get_n_itemsets(
        ...
        """
        Gets the k-itemsets of the frequent pattern itemsets
        :param filtered_frequent_itemsets:
        :param n: k
        :return: all the itemsets with length n
        """
        return {
